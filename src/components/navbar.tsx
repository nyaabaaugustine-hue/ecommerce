      ...
      <div className="bg-secondary text-white py-1.5 px-4 md:px-10 flex items-center justify-between text-[8px] font-black uppercase tracking-widest border-b border-white/5">
         ...
         <div className="flex items-center gap-6">
            <div className="flex items-center gap-4 opacity-70">
               <span className="hover:text-accent cursor-pointer transition-colors">Sell on Vault</span>
      ...
      <div className="bg-white border-b py-3 shadow-md">
        <div className="container mx-auto px-4 flex items-center justify-between gap-6">
          ...
          <div className="flex-1 max-w-xl relative" ref={searchRef}>
            <div className="relative w-full flex shadow-sm border border-secondary/10 overflow-hidden">
              <input 
                type="text" 
              ...
              />
              <Button className="rounded-none h-auto px-6 bg-secondary hover:bg-primary text-white font-black uppercase text-[10px] tracking-widest border-none">
            ...
            {showSuggestions && searchQuery.length > 0 && (
              <div className="absolute top-full left-0 w-full bg-white border border-t-0 shadow-2xl z-50 rounded-none">
                {suggestions.map((s) => (
                  ...
                  >
                    <div className="relative h-8 w-8 bg-muted shrink-0">
