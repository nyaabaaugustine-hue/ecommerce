      ...
      <body className="font-body antialiased bg-background min-h-screen flex flex-col text-secondary" suppressHydrationWarning>
        <AuthProvider>
          <CartProvider>
            ...
            <footer className="bg-secondary text-white pt-16 md:pt-24 pb-12 border-t border-primary/20">
              <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 mb-16 md:mb-24">
                  <div className="space-y-8">
                     <div className="flex items-center gap-4 font-headline font-black text-2xl md:text-3xl text-white">
                        <div className="relative h-10 w-10 md:h-12 md:w-12 overflow-hidden rounded-none border border-primary/30">
                          <Image 
                     ...
                     <div className="space-y-3">
                        ...
                        <p className="text-lg md:text-xl font-black text-primary">+233 24 000 0000</p>
                     </div>
                  </div>
                  
                  <div>
                    <h4 className="font-black text-lg md:text-xl mb-6 md:mb-8 tracking-tighter">Marketplace Registry</h4>
                    <ul className="space-y-4 md:space-y-5 text-white/50 text-[10px] md:text-sm font-bold uppercase tracking-widest">
                  ...
                  <div>
                    <h4 className="font-black text-lg md:text-xl mb-6 md:mb-8 tracking-tighter">Fidelity Security</h4>
                    <ul className="space-y-4 md:space-y-5 text-white/50 text-[10px] md:text-sm font-bold uppercase tracking-widest">
                  ...
                  <div>
                    <h4 className="font-black text-lg md:text-xl mb-6 md:mb-8 tracking-tighter">Mobile Registry</h4>
                    <p className="text-white/50 text-xs md:text-sm mb-6 md:mb-8 font-medium">Manage your registry assets on the go. Available for sovereign users.</p>
                    <div className="flex flex-col gap-4">
                      <Image src="https://placehold.co/200x60/0a1a2f/ffffff?text=App+Store" alt="App Store" width={200} height={60} className="rounded-xl cursor-pointer hover:brightness-125 transition-all shadow-2xl w-[160px] md:w-[200px]" unoptimized />
                      <Image src="https://placehold.co/200x60/0a1a2f/ffffff?text=Google+Play" alt="Google Play" width={200} height={60} className="rounded-xl cursor-pointer hover:brightness-125 transition-all shadow-2xl w-[160px] md:w-[200px]" unoptimized />
                    </div>
                  </div>
                </div>
                
                <div className="pt-12 border-t border-white/5 text-center text-white/30 text-[9px] md:text-xs font-black uppercase tracking-[0.4em]" suppressHydrationWarning>
