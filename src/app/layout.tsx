                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
                    <div className="lg:col-span-1 space-y-4">
                       ...
                       <div className="space-y-1">
                          ...
                          <p className="text-base font-black text-white">+233 24 000 0000</p>
                       </div>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-white/50 text-[9px] mb-4 font-medium leading-relaxed">Manage your registry assets on the go. Available for sovereign users.</p>
                      <div className="flex flex-col gap-2">
                        <Image 
                          ...
                          width={160} 
                          height={48} 
                          className="rounded-none cursor-pointer hover:brightness-110 transition-all shadow-xl" 
                          unoptimized 
                        />
                      </div>
                    </div>
