...
export const LISTINGS: Listing[] = [
  ...
  // FURNITURE (5 ITEMS - CLONE FROM IMAGE)
  {
    id: 'f1',
  ...
  {
    id: 'ac1',
    title: 'Split Hi-Wall 12000 BTUs Eco',
    price: 2450,
    oldPrice: 2800,
    isNegotiable: false,
    category: 'Electronics',
    location: 'Accra Mall Node',
    postedAt: '2h ago',
    postedTimestamp: Date.now() - 7200000,
  ...
  {
    id: 'ac2',
    title: 'Portable Air Conditioner 9000 BTUs',
    price: 3200,
    isNegotiable: true,
    category: 'Electronics',
    location: 'Osu',
    ...
    vendorId: 'v1',
    description: 'Mobile cooling solution.',
    status: 'Active',
    isEscrowProtected: true,
    seller: { id: 's3', name: 'Melcom Digital', type: 'Verified Dealer', rating: 4.8, isVerified: true, joinDate: '2022', phone: '0541988383', whatsapp: '233541988383' }
  },
  {
    id: 'ac3',
    title: 'Inverter Split AC 18000 BTUs',
    price: 4800,
    oldPrice: 5500,
    isNegotiable: false,
    category: 'Electronics',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1631541119392-e700300f689c?q=80&w=800&auto=format&fit=crop',
    vendorId: 'v1',
    description: 'Powerful inverter cooling.',
    status: 'Active',
    isEscrowProtected: true,
    isEasyDelivery: true,
    seller: { id: 's3', name: 'Melcom Digital', type: 'Verified Dealer', rating: 4.8, isVerified: true, joinDate: '2022', phone: '0541988383', whatsapp: '233541988383' }
  ...
  {
    id: 'ac4',
    title: 'Window Unit AC 7500 BTUs',
    price: 1850,
    isNegotiable: true,
    category: 'Electronics',
    location: 'Tema',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1585338107529-13afc5f02586?q=80&w=800&auto=format&fit=crop',
    vendorId: 'v1',
    description: 'Classic window unit.',
    status: 'Active',
    isEscrowProtected: true,
    seller: { id: 's3', name: 'Melcom Digital', type: 'Verified Dealer', rating: 4.8, isVerified: true, joinDate: '2022', phone: '0541988383', whatsapp: '233541988383' }
  },
  {
    id: 'ac5',
    title: 'Multi-Split System Dual Zone',
    price: 8900,
    oldPrice: 10500,
    isNegotiable: false,
    category: 'Electronics',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1631541119392-e700300f689c?q=80&w=800&auto=format&fit=crop',
    vendorId: 'v1',
    description: 'Two zone cooling solution.',
    status: 'Active',
    isEscrowProtected: true,
    isEasyDelivery: true,
    seller: { id: 's3', name: 'Melcom Digital', type: 'Verified Dealer', rating: 4.8, isVerified: true, joinDate: '2022', phone: '0541988383', whatsapp: '233541988383' }
